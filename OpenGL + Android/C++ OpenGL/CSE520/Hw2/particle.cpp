...
void display(void)
{
   ...
   glBegin (GL_LINES);  
     glVertexAttrib3f(velParam, 0, 3, 0 );	//v1 - v2 -> v1 - v4
     glVertex3f(0, 2, 0);
     glVertexAttrib3f(velParam, 2, 2.5, 0 );			
     glVertex3f(-1,0,0);
   glEnd();
   glBegin (GL_LINES);
     glVertexAttrib3f(velParam, 0, 3, 0);     //v2 - v3 -> v1 - v3
     glVertex3f(-1,0,0);
     glVertexAttrib3f(velParam, 0, 1, 0 );
     glVertex3f(-2,-2,0);
   glEnd();
   glBegin (GL_LINES);   
     glVertexAttrib3f(velParam, 0, 2, 0);     //v1 - v4 -> v2 - v4
     glVertex3f(0,2,0);
     glVertexAttrib3f(velParam, 2, 2.5, 0 );
     glVertex3f(1,0,0);
   glEnd();
   glBegin (GL_LINES);
     glVertexAttrib3f(velParam, 0, 2, 0);     //v2 - v4
     glVertex3f(-1,0,0);
     glVertexAttrib3f(velParam, 2, 1.5, 0 );
     glVertex3f(1,0,0);
   glEnd();
   glBegin (GL_LINES);
     glVertexAttrib3f(velParam, 0, 1, 0);     //v4 - v5
     glVertex3f(1,0,0);
     glVertexAttrib3f(velParam, 2, 1.5, 0);
     glVertex3f(2,-2,0);
   glEnd();
 /*  glBegin(GL_LINES);
     glVertexAttrib3f(velParam, 2, 0, 0);
     glVertexAttrib1f(loc,true);               //v2 - v5
     while (t > 5000) t-= 5000;
     if (t >= 2500 && t <= 5000) {
        glVertexAttrib1f(loc,false);
     }
     glVertex2f(-1,0);
     glVertexAttrib3f(velParam, 2, 0, 0 );
     glVertex2f(2,-2);
